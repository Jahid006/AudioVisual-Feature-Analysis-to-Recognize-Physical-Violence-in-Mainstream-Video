...
"""
python feat_extract.py --data-list video.txt --model inceptionv3_kinetics400 --save-dir ./features xx
...
python feat_extract.py --data-list video.txt --i3d_nl10_resnet50_v1_kinetics400 --save-dir ./features --num-segments 10
python feat_extract.py --data-list video.txt --model r2plus1d_resnet50_kinetics400 --save-dir ./features --num-segments 5 --gpu-id -1
python feat_extract.py --data-list video.txt --model p3d_resnet50_kinetics400 --save-dir ./features
python feat_extract.py --data-list video.txt --model p3d_resnet50_kinetics400 --save-dir ./features --num-segments 5 
""" 
class OPT_:
    version = ''
    data_list= make_text_file(video_files_path= 'F:/S-Home/r2/data/dataset/my_dataset/video',text_file_path ='video.txt')
    save_dir='./features'
    dtype='float32'
...
def main(logger):
    ...
    #logger.info(f'processing video samples {start_idx} to {end_idx}'),[start_idx:end_idx]
    for vid, vline in enumerate(data_list):
        ...
        feat_file = feat_file.replace('/video', f"/video/{model_name.split('_')[0]+'.'+str(10)}s{opt.version}")
