...
from utility import times, dict_to_json, generate_report_skl, Exit, plot_acc,plot_loss
...
def make_dir(path):
    if not os.path.exists(path):
        ...
        Exit('Directories already exists. Proceeding to train a model with\
